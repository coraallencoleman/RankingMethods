...
#creates vectors of HPD intervals (length = 2*71)
...
#post_ranks <- t(apply(lbw_ranks,1,function(x) table(factor(x,levels=1:71))/10000))
#post_ranks <- post_ranks/max(post_ranks)
post_df <- melt(post_ranks)
