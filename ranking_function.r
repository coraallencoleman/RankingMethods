...
## TODO weights question: what should epsilon be? When do we have numerical stability problem

## TODO bring in heuristic methods for LSAP look for papers by Louis' group 
## TODO idea for visualizations: D3.js? this could be a good situation to use weights based on people's interests. Show different weight vectors.

## TODO Test different weighting strategies
